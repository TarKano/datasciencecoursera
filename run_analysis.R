...
path <- getwd();url <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
...
featuresWanted <- grep("(mean|std)\\(\\)", features[, featureNames]);measurements <- features[featuresWanted, featureNames]
